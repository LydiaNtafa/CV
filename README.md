...
| ---------------------------- | ----------------- | ----------------- |
| **BeatBooker** | Work In progress. Our team wants to deploy a webapp where DJs can create their online profile where they can share examples of their work and their availability. Those profiles will be available for promoters to browse and express their interest into booking those DJs for their events. Our goal is to provide a safe promotional tool that is currently lacking from the UK industry | React, Typescript, Python, DJango, Docker |
...
- Handled customer contacts across multiple channels including phone, email amd social media channel meeting the company's SLAs.
- Handled all returned products to make sure all refunds where processed timely and according to company's policies. Making sure that the products where passed the quality checkes before being added back tot he inventory, or identifying part sof the products that can be used for parts, as part of the company's reuse and upcycle values. <br>
...
***Skills***  *: Basic Internet Pronciples · Communication · Resourcefulness · Empathy · Active Listening · Goal Setting*
