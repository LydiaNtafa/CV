...
| ---------------------------- | ----------------- | ----------------- |
| **BeatBooker** | Work In progress. Our team wants to deploy a web app where DJs can create their online profiles, share examples of their work and their availability. Those profiles will be available for promoters to browse and express their interest in booking those DJs for their events. Our goal is to provide a safe promotional tool that is currently lacking in the UK industry | React, Typescript, Python, DJango, Docker |
